...
static lv_task_cb_t user_task_cb(lv_task_t * task)
{
//    lv_img_set_src(num_img_temp[0],num_img_array[global_time / 200 % 9][global_time % 10]);
//    lv_img_set_src(num_img_temp[1],num_img_array[global_time / 200 % 9][global_time / 10 % 10]);
//    lv_img_set_src(num_img_temp[2],num_img_array[global_time / 200 % 9][global_time /100 % 10]);
